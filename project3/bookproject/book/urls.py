...
urlpatterns = [
    path('book/', views.ListBookView.as_view(), name = 'list-book'), # name is used in reverse_lazy
    path('book/<int:pk>/detail/', views.DetailBoookView.as_view(), name = 'detail-book'),
